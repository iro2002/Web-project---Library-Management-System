<?php
require 'dbcon.php';
require 'manageuser_req_pros.php';
                    ...
                    <div class="container">
                        <section>
                            <div class="form-container">
                                ...
                                <form action="manageuser_index.php" method="post" onsubmit="return validateForm();">
                                    <div class="form-group">
                                        <label for="user_id">User ID</label>
                                        <input type="text" id="user_id" name="user_id" value="<?php echo $user_id; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
